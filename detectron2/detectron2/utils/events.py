...
class LOFARMetricPrinter(EventWriter):
    """
    Print LOFAR metrics to the terminal, including
    iteration time, ETA, memory, all losses, and the learning rate.
    ...
    def write(self):
        ...
        """
        # Log LOFAR metrics
        storage.put_scalars(loss_single_incl_asso=,
                            loss_multi_incl_asso=,
                            loss_single_incl_unasso=,
                            loss_multi_incl_unasso=)
