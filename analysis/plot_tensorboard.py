...
plt.plot(iteration, precision_tiny, label="0.1")
plt.plot(iteration, precision_small, label="0.25")
plt.plot(iteration, precision_medium, label="0.5")
# plt.plot(
#    iteration,
...
plt.plot(
    ...
    [x["total_loss"] for x in experiment_metrics_tiny],
    label="0.1",
)
plt.plot(
    [x["iteration"] for x in experiment_metrics_small],
    [x["total_loss"] for x in experiment_metrics_small],
    label="0.25",
)
plt.plot(
    [x["iteration"] for x in experiment_metrics_medium],
    [x["total_loss"] for x in experiment_metrics_medium],
    label="0.5",
)
plt.plot(
    [x["iteration"] for x in experiment_metrics_large],
    [x["total_loss"] for x in experiment_metrics_large],
    label="0.75",
)
plt.plot(
    [x["iteration"] for x in experiment_metrics_all],
    [x["total_loss"] for x in experiment_metrics_all],
    label="1.0",
)
plt.plot(list(range(0, 400000, 1000)), precision_tiny, label="0.1 Val")
plt.plot(list(range(0, 400000, 1000)), precision_small, label="0.25 Val")
plt.plot(list(range(0, 400000, 1000)), precision_medium, label="0.5 Val")
plt.plot(list(range(0, 400000, 1000)), precision_large, label="0.75 Val")
plt.plot(list(range(0, 400000, 1000)), precision_huge, label="1.0 Val")
plt.legend(loc="upper right")
...
plt.plot(iteration, precision_small, label="0.25")
plt.plot(iteration, precision_medium, label="0.5")
plt.plot(iteration, precision_large, label="0.75")
plt.plot(iteration, precision, label="1.0")
plt.legend(loc="upper right")
