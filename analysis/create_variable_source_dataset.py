...
create_coco_dataset(root_directory=cutout_directory, multiple_bboxes=False, rotation=None, convert=False, all_channels=True, precomputed_proposals=True, resize=400)
create_coco_dataset(root_directory=cutout_directory, multiple_bboxes=False, rotation=None, convert=False, all_channels=True, precomputed_proposals=False, resize=400)
